...
export default class Publicacao {
  ...
  setDataCriacao(dataCriacao) {
    Publicacao.validarDataCriacao(dataCriacao);
  ...
  setTitulo(titulo) {
    Publicacao.validarTitulo(titulo);
    this.titulo = titulo;
  }
  ...
  setConteudo(conteudo) {
    Publicacao.validarConteudo(conteudo);
  ...
  setEsportes(esportes) {
    Publicacao.validarEsportes(esportes);
  ...
  static validarDataCriacao(dataCriacao) {
    if (!dataCriacao || isNaN(Date.parse(dataCriacao))) {
      throw new ModelError("Data de criação inválida.");
    }
  }
